...
<div class="col-12 keynote-block">
    <h2 class="d-block mb-0">Spotlight on our Keynote Speakers</h2>
    <div class="row">
        <p class="col-12">
        ...
        <div class="col-md-4 mt-4">
            ...
            <p class="speaker-name text-center">Prof Petra Huppi</p>
            </a>
        </div>
        <div class="col-md-4 mt-4">
            <a href="https://vimeo.com/571419124" target="_blank">
            <img class="w-100" src="./img/keynote/home/yroe.jpg">
            <p class="speaker-name text-center">A/Prof Yvette Roe</p>
            </a>
        </div>
        <div class="col-md-4 mt-4">
            <a href="https://vimeo.com/549156270" target="_blank">
            <img class="w-100" src="./img/keynote/home/smiller.png">
            <p class="speaker-name text-center">Prof Suzie Miller</p>
            </a>
        </div>
        <div class="col-md-4 mt-4">
            <a href="https://vimeo.com/537515376" target="_blank">
            <img class="w-100" src="./img/keynote/home/smichie.png">
            <p class="speaker-name text-center">Prof Susan Michie</p>
            </a>
        </div>
        <div class="col-md-4 mt-4">
            <a href="https://vimeo.com/543004376" target="_blank">
            <img class="w-100" src="./img/keynote/home/rlieber.png">
            <p class="speaker-name text-center">Prof Rick Lieber</p>
            </a>
        </div>
        <div class="col-md-4 mt-4">
            <a href="https://vimeo.com/571419124" target="_blank">
            <img class="w-100" src="./img/keynote/home/skildea.jpg">
            <p class="speaker-name text-center">Prof Sue Kildea</p>
            </a>
        </div>
    </div>
</div>
<div class="col-12 mt-4 btns-block">
    <div class="row">
        <div class="col-md-6 mt-4 register-banner">
            <a href="https://bettertogether2022.org/registration.php">
            <img class="w-100" src="./img/rn.jpg">
            <p class="position-absolute my-0">Register</br>Now!</p>
            </a>
        </div>
        <div class="col-md-6 mt-4 is-banner">
            <a href="interactive-sessions.php">
            <img class="w-100" src="./img/is.jpg">
            <p class="position-absolute my-0">Interactive</br>Sessions</p>
            </a>
        </div>
    </div>
</div>
