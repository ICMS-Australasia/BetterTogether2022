...
<p>The Scientific Committee invites you to submit abstracts now for Late Breaking Free Papers.</p>

<h3>Meeting policy reminders:</h3>
<ul>
	...
	<li>All presenters of accepted abstracts are required to register for the conference. Fees are not reduced or waived for presenters. An alternate author should be prepared to attend and present if an emergency causes the primary author’s absence.</li>
</ul>

<h3>Expectations of abstract submissions:</h3>
<ul>
...
<h4 style="color: red;"><b>The deadline for submission is: 23:59 (AEDT) 1 December 2021.</b></h2>

<p>Submissions are welcomed over a wide range of conditions and themes including: </p>

<h3>Conditions</h3>
<ul class="row">
	<li class="col-6">Acquired brain injury</li>
	<li class="col-6">Autism Spectrum Disorder</li>
	<li class="col-6">Cerebral palsy</li>
	<li class="col-6">Cerebral visual impairment</li>
	<li class="col-6">Chromosomal disorders</li>
	<li class="col-6">Neonatal Brachial Plexus palsy</li>
	<li class="col-6">Neuromuscular disorders</li>
	<li class="col-6">Spinal Bifida</li>
	<li class="col-6">Spinal cord injury and disease</li>
	<li class="col-6">Other</li>
</ul>

<h3>Themes</h3>
<ul class="row">
	<li class="col-6">Adults and transitional care</li>
	<li class="col-6">Aetiology, epidemiology and casual mechanisms</li>
	<li class="col-6">Care in lower resource settings </li>
	<li class="col-6">Clinical practice guidelines, care pathways</li>
	<li class="col-6">Cognitive rehabilitation </li>
	<li class="col-6">Communication and assistive devices</li>
	<li class="col-6">Indigenous and First Nations people and disability</li>
	<li class="col-6">Intensive motor interventions</li>
	<li class="col-6">Knowledge translation and implementation</li>
	<li class="col-6">Living and planning for pandemics and disasters</li>
	<li class="col-6">Mental health and wellbeing </li>
	<li class="col-6">Movement disorders and hypertonia/hypotonia management</li>
	<li class="col-6">Neuroscience and neuroimaging</li>
	<li class="col-6">New technologies, innovations and robotics</li>
	<li class="col-6">Nutrition, diet, feeding and oropharyngeal dysphagia </li>
	<li class="col-6">Consumer engagement, social policy and service delivery</li>
	<li class="col-6">Disability management during a pandemic / disaster</li>
	<li class="col-6">Early detection, neonatal care and early interventions </li>
	<li class="col-6">Family/caregiver health and wellbeing</li>
	<li class="col-6">Genomics</li>
	<li class="col-6">Orthopaedics, muscle and bone health</li>
	<li class="col-6">Pain</li>
	<li class="col-6">Participation</li>
	<li class="col-6">Physical activity, fitness and sports/leisure</li>
	<li class="col-6">Physical rehabilitation/habilitation</li>
	<li class="col-6">Preclinical studies, neuroprotection, prevention & neural repair</li>
	<li class="col-6">Sleep</li>
	<li class="col-6">Telehealth</li>
	<li class="col-6">Vision</li>
	<li class="col-6">Other</li>
</ul>

<a href="https://icmsaust.eventsair.com/ausacpdmiaacd-2022---childhood-disabilities/late-breaking" target="_blank" class="button d-block text-center">Submit your abstract here</a>
