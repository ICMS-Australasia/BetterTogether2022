...
<h3>Registration Entitlements:</h3>



<ul>
	<li>Access to the online Conference platform</li>
	<li>Admission to all Conference sessions 2 - 5 March 2022</li>
	<li>Networking opportunity through the online Conference platform</li>
	<li>Access to the online Exhibition </li>
	<li>Access to all posters through the online gallery</li>
	<li>Access to on-demand content post event</li>
...
<a href="https://icmsaust.eventsair.com/ausacpdmiaacd-2022---childhood-disabilities/registration-form-virtual" target="_blank" class="button d-block text-center">Conference & Workshop Registration Form</a>
...
<table width="100%" class="reg-table" cellpadding="10px">
  ...
  <tr align="center">
    ...
    <th>Early-Bird <br> <span><em>Before 1 November 2021</em></span> </th>
    <th>Standard <br> <span><em>After 1 November 2021</em></span> </th>
  </tr>
  ...
  <tr class="highlight">
    <td colspan="3">Registration Add-on</td>
  </tr>

  <tr bgcolor="#f2f2f2">
    <td>Short Workshop - Tuesday 1 March 2022</td>
    <td align="center" colspan="2">$25</td>
  </tr>

  <tr>
    <td>Long Workshop - Tuesday 1 March 2022</td>
     <td align="center" colspan="2">$50</td>
  </tr>

  <tr class="highlight">
    <td colspan="3">Standalone Pre-Conference Workshop Registration</td>
  </tr>
...
<p>For your convenience please see the following link to a <a href="https://www.xe.com/currencyconverter/" target="_blank">currency convertor.</a></p>
 ...
 <p>To be eligible for the Low Resource Nation Registration yiou must come from a country on the <a href="https://www.research4life.org/access/eligibility/" target="_blank">HINARI list.</a>

<h3>Pre-Conference Workshops</h3>
<p>All pre-conference workshops will be taking place on Tuesday 1 March 2022, only people who have purchased a ticket to a workshop will have access to join this workshop, view the content and watch the on-demand recording. To be eligible for the registration add-on workshop fees, registrants must register and pay for a full conference registration, for people only attending a workshop and not the conference they must register at the standalone pre-conference workshop fee. <a href="https://bettertogether2022.org/pre-conference-workshops.php" target="_blank">View the list of Workshops.</a></p>

 <h2>Disclaimer</h2>
 <p>All best endeavours will be made to present the program as displayed on this website. The Conference and its agents reserve the right to alter without prior notice, any of the arrangements, timetables, plans or other items relating to the Conference, for any cause beyond its reasonable control. The Organising Committee and the Conference Organisers are not liable for any loss or inconvenience caused as a result of such alteration. In the event of unforeseen circumstances, the Organising Committee and the Conference Organisers do not accept responsibility for loss of monies caused by delays. </p>
 <p>For full registration and accommodation terms and conditions, <a href="./terms-and-conditions.php">please click here.</a></p>
...
<ul>
  ...
  <li>Access to the on-line Conference platform</li>
  ...
  <li>Networking opportunity through the on-line Conference platform</li>



  <li>Access to the on-line Exhibition</li>



  <li>Access to all posters through the on-line gallery</li>
 ...
 <h3>In-person Registration Entitlements:</h3>
...
<ul>
  ...
  <li>Access to all Virtual Registration benefits plus the below</li>



  <li>Admission to all live Conference sessions 2 - 5 March 2022</li>



  <li>Morning tea, lunch and afternoon tea daily</li>



  <li>Delegate materials</li>



  <li>Ticket to the Welcome Reception</li>



  <li>Entry access to the Exhibition</li>



  <li>Access to the poster gallery</li>



  <li>Opportunity to purchase social tickets</li>
...
<p>Registration can be submitted by completing the on-line form. Both virtual and in person registrations are available via the on-line registration form.</p>
 ...
 <a href="https://icmsaust.eventsair.com/ausacpdmiaacd-2022---childhood-disabilities/registration-form-virtual" target="_blank" class="button d-block text-center">Registration Form</a>
