      ...
      <?php } ?>
        <table class="key-dates-side" cellpadding="15" cellspacing="0" border="0" width="100%">
            ...
            <tr align="center" class="conference-heading"><th>Better Together 2022</th></tr>
                <tr align="center"  class="conference"><th>Pre-conference Workshops 1 March 2022</th></tr>
...
<div class="col text-center">
    <h1 class="teal">Our Partners</h1>
    <div class="row d-flex justify-content-center align-items-end">
        <div class="col-4">
            <img src="https://via.placeholder.com/300x200" alt="AusACPDM Logo" class="img-fluid">
        </div>
        <div class="col-4">
            <img src="https://via.placeholder.com/300x200" alt="IAACD Logo" class="img-fluid">
        </div>
        <div class="col-4">
            <img src="https://via.placeholder.com/300x200" alt="IAACD Logo" class="img-fluid">
        </div>
...
<div class="col-12 col-lg-7">
    ...
    <div class="row">
        ...
        <div class="col-12">
            <h3 class="mt-2 d-flex  justify-content-center">
                #bettertogether2022
            </h3>
        </div>
    </div>
