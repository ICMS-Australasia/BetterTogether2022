...
<script async src="https://www.googletagmanager.com/gtag/js?id=G-6MJK9QJ422"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'G-6MJK9QJ422');
</script>
</head>
<body>
    ...
    <div class="container-fluid">
      <div class="row align-items-center ">
        <div class="col text-center">
            <a href="#content"><b>Skip to content</b><i class="fas fa-caret-down ml-2"></i></a>
        </div>
      </div>
    </div>
</div> -->
        ...
        <div class="row">
            <div class="col-12 text-center">
                <div class="conference-name">
                    <p class="p-4 p-lg-5"><b>Combined <span>11th Australasian Academy of Cerebral Palsy and Developmental Medicine</span> and the <span>3rd International Alliance of Academies of Childhood Disability</span> 'Better Together' Conference 2022</b></p>
                </div>
            </div>
        </div>
    </div>
